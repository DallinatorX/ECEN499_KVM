...
echo "-------SETTING AUDIO PROFILE 2 ACTIVE-------"
pactl set-card-profile 2 input:analog-stereo    # Set capture card audio device 2 to active
...
pactl load-module module-loopback   # load loopback to monitor audio from capture card